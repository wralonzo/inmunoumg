...
<form class="flex items-center justify-center flex-1" method='POST' action="<?php echo base_url(); ?>Pacientes/register/<?php echo (isset($idPaciente) ? $idPaciente : '') ?>">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
        <h1 class="text-3xl font-bold text-gray-500 text-center">Paciente</h1><br>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <?php $value = (isset($paciente) ? $paciente->nombrepaciente : ''); ?>
            ...
            <div class="md:w-1/2 px-3">
                ...
                <?php $value = (isset($paciente) ? $paciente->apellidopaciente : ''); ?>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3">
                ...
                <?php $value = (isset($paciente) ? $paciente->cui : ''); ?>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3">
                ...
                <div class="selector-region">
                    <select id='padre' name='idpadre' class=" block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state" required>
                        <option value="">Seleecion una un padre</option>
                        <?php foreach ($padres as $padre) : ?>
                            <?php if ($padre->idpadre == $paciente->idpadre) {
                            ?>
                                <option value="<?php echo $padre->idpadre ?>" selected="selected"><?php echo $padre->nombre . ' ' . $padre->apellido ?></option>
                            <?php } ?>
                            <option value="<?php echo $padre->idpadre ?>"><?php echo $padre->nombre . ' ' . $padre->apellido ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3">
                ...
                <?php $value = (isset($paciente) ? $paciente->fechanacimiento : ''); ?>
                <input name="fechanacimiento" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-last-name" type="date" required value="<?php echo $value ?>" required>
            </div>
        </div>

        <div class="md:w-1/2 px-3">
            <!-- AlpineJS -->
            <?php $value = (isset($paciente) ? $paciente->sexo : ''); ?>
