            ...
            <tbody>
                ...
                foreach ($response as $queja) { ?>
                    <tr class="">
                        ...
                        <td align="center"><a href="<?php echo base_url(); ?>Queja/update/<?php echo $queja->id_queja ?>" class="px-2 py-1 bg-blue-600 text-gray-100 font-bold rounded hover:bg-gray-500"><?php echo $queja->concepto_queja; ?></a></td>
                        ...
                        <td align="center"><?php echo $queja->fecha; ?></td>
