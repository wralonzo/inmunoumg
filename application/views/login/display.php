...
<div class="mx-auto px-12">
    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            <a href="<?php echo base_url(); ?>Login/register" class="text-center focus:outline-none text-white text-sm py-2.5 px-12 rounded-md bg-purple-500 hover:bg-purple-600 hover:shadow-lg">Nuevo</a>
        </div><br>
            ...
            <tbody>
                ...
                foreach ($usuarios as $user) { ?>
                    <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                        ...
                        <td><a href="<?php echo base_url(); ?>Login/update/<?php echo $user->id_empleado ?>" class="px-2 py-1 bg-blue-600 text-gray-100 font-bold rounded hover:bg-gray-500"><?php echo $user->nombres; ?></a></td>
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="<?php echo base_url(); ?>Login/update/<?php echo $user->id_empleado ?>">
